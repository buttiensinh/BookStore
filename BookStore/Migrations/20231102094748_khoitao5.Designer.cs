...
namespace BookStore.Migrations
{
    ...
    [Migration("20231102094748_khoitao5")]
    partial class khoitao5
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BookStore.Models.Sach", b =>
                {
                    ...
                    b.Property<string>("NhaSanXuatID")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("NhaSanXuatID1")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("TheLoaiID")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("TheLoaiID1")
                        .HasColumnType("int");

                    b.HasKey("ID");

                    b.HasIndex("NhaSanXuatID1");

                    b.HasIndex("TheLoaiID1");
            ...
            modelBuilder.Entity("BookStore.Models.Sach", b =>
                {
                    b.HasOne("BookStore.Models.NhaSanXuat", "NhaSanXuat")
                        .WithMany("Sach")
                        .HasForeignKey("NhaSanXuatID1");

                    b.HasOne("BookStore.Models.TheLoai", "TheLoai")
                        .WithMany("Sach")
                        .HasForeignKey("TheLoaiID1");
