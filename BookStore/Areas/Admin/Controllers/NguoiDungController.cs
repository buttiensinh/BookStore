...
namespace BookStore.Areas.Admin.Controllers
{
	...
	public class NguoiDungController : Controller
    {
        ...
        public NguoiDungController(BookStoreDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.NguoiDung != null ? 
                          ...
                          Problem("Entity set 'BookStoreDBContext.NguoiDung'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BookStoreDBContext.NguoiDung'  is null.");
            }
            var nguoiDung = await _context.NguoiDung.FindAsync(id);
            if (nguoiDung != null)
            {
